      ...
      render: (text, data) => {
        return (
          <div className="d-flex align-items-center gap-10">
            ...
            <Button className="border-2 border-red-500" onClick={() => handleDelete(data._id)}>
              <DeleteOutlined />
            </Button>
            {data.isActive && (
              <Button
  ...
  return (
    ...
    >
      <div className="d-flex justify-content-between">
        ...
        {view === "table" && (
          <Button type="primary" className="bg-red-500 text-white font-bold text-base mb-3" onClick={() => setView("form")}>
            Add Show
          </Button>
        )}
      </div>
...
export default AddShowOnTheatresForm;
